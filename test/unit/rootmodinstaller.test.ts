jest.mock('@butr/blmodulemanagernative/dist/module/lib', async () => {
  return await import('@butr/blmodulemanagernative/dist/main/lib');
});
jest.mock('@butr/blmodulemanagernative/dist/module/lib/types', async () => {
  return await import('@butr/blmodulemanagernative/dist/main/lib/types');
});
