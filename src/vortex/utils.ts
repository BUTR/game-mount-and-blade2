...
export const getPersistentBannerlordMods = (
  statePersistent: IStatePersistent,
): IBannerlordModStorage => {
...
export const hasPersistentBannerlordMods = (
  ...
  nameof<IStatePersistentWithBannerlordMods>("mods") in statePersistent &&
  GAME_ID in statePersistent.mods;

export const hasSession = (hasSession: object): hasSession is HasSession =>
  nameof<HasSession>("session") in hasSession;

export const hasSessionWithBannerlord = (
  stateSession: IStateSession,
): stateSession is IStateSessionWithBannerlord =>
