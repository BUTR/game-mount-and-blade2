...
import {
  More, Toggle, selectors, util, types,
} from 'vortex-api';
...
const Settings = (props: IProps): JSX.Element => {
  const {
    t, autoSortOnDeploy, onSetSortOnDeploy, profileId,
  } = props;
...
export default withTranslation([`common`, NAMESPACE])(connect(mapState)(Settings)) as React.ComponentType<IProps>;
