...
export const LoadOrderInfoPanel = (
  ...
  const openWiki = useCallback(() => {
    util
      .opn(
        `https://wiki.nexusmods.com/index.php/Modding_Bannerlord_with_Vortex`,
      )
      .catch(() => null);
  }, []);
  const hint = t(
    ...
    <>
      ...
      <p>
        ...
        <ul>
          <li>
            {t(
              `Check the box next to the mods you want to be active in the game.`,
            )}
          </li>
          <li>
            {t(`Click Auto Sort in the toolbar. (See below for details).`)}
          </li>
          <li>
            {t(
      ...
      <div>
        <p>
          ...
          <ul>
            ...
            <li>
              {t(
                `Hit the deploy button whenever you install and enable a new mod.`,
              )}
            </li>
            <li>
              {t(
