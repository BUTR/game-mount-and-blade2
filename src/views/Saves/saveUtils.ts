...
export const getNameDuplicatesError = (saveGame: ISaveGame, launcherManager: VortexLauncherManager, availableModules: Readonly<IModuleCache>): string | undefined => {
...
export const getMissingModuleNamesError = (saveGame: ISaveGame, launcherManager: VortexLauncherManager, availableModules: Readonly<IModuleCache>): Array<string> => {
  const availableModulesByName = getAvailableModulesByName(availableModules);
...
export const getMismatchedModuleVersionsWarning = (saveGame: ISaveGame, launcherManager: VortexLauncherManager, availableModules: Readonly<IModuleCache>): string | undefined => {
  const availableModulesByName = getAvailableModulesByName(availableModules);
...
export const getLoadOrderIssues = (saveGame: ISaveGame, launcherManager: VortexLauncherManager, availableModules: Readonly<IModuleCache>): Array<string> => {
  const availableModulesByName = getAvailableModulesByName(availableModules);
...
export const getModules = (saveGame: ISaveGame, launcherManager: VortexLauncherManager): Array<ModuleInfoExtendedWithPathWithVortexMetadata> => {
