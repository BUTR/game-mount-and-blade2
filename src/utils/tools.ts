...
export const addBLSETools = async (api: types.IExtensionApi, discovery: types.IDiscoveryResult): Promise<void> => {
  ...
  const tools = [
    ...
    { id: 'blse-launcher', name: `Bannerlord Software Extender Official Launcher`, exe: BLSE_LAUNCHER_EXE },
    { id: 'blse-launcherex', name: `Bannerlord Software Extender LauncherEx`, exe: BLSE_LAUNCHEREX_EXE },
  ];
